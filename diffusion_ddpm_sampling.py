...
class DDPM_Sampler(nn.Module):
    ...
    def sampling(self, n_samples=5, data_dim=2, params=None, device='cuda'):
        ...
        if not self.training: self.save_result(sample_zero, intermediate_smpl, noise_norm, noises, params)
...
def ddpm_sampling(expr_id, n_timestep_smpl=-1, n_sel_time=10, n_samples=36, train_name=None, test_name=None):
